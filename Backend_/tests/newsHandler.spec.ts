...
describe('ServiceNewsReports Handler', () => {
    ...
    it('NewsReport::Get NotFound response when send a Get Request for an InexistentId', async () => {
    ...
    it('NewsReport::Get Created response when send a Post Request', async () => {
    ...
    it('NewsReport::Get OK response when send a Put Request', async () => {
